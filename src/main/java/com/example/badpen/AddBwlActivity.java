...
public class AddBwlActivity extends Activity {
    ...
    private DatePickerDialog.OnDateSetListener dateSetListener = new DatePickerDialog.OnDateSetListener() {
        ...
        public void onDateSet(DatePicker datePicker, int year, int month, int day) {
            ...
            dateStr.append(year).append("-").append(month+1).append("-").append(day);
    ...
    /**
     * 当Activity调用showDialog函数是会触发该函数的调用
     */
    ...
    public void setAlarm(long id){
        ...
        calendar.set(Integer.parseInt(noticeDate.split("-")[0]),
                ...
                Integer.parseInt(noticeDate.split(":")[0]),
                Integer.parseInt(noticeDate.split(":")[1]));
